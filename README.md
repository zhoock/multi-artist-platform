# Название сайта — музыкальная платформа для независимых артистов

Мультиартистная музыкальная платформа для публикации альбомов, статей и поддержки независимых артистов.

---

## Описание проекта

Платформа объединяет публичные страницы артистов, каталог альбомов с треками и синхронизированными текстами, статьи, медиаплеер, мультиязычность (RU/EN) и личные кабинеты для артистов и слушателей. Контент (альбомы, треки, тексты, синхронизации, статьи, изображения hero) хранится в PostgreSQL (Supabase), медиафайлы — в Supabase Storage. Для продакшена используется хостинг Netlify и serverless-функции для API.

**Основные возможности:**

- Публичные страницы артистов и каталог релизов
- Просмотр альбомов и треков с аудиоплеером и синхронизированными текстами
- Статьи и публикации с мультиязычной поддержкой
- Двуязычный интерфейс (русский / английский)
- Кабинет артиста: управление альбомами, треками, синхронизациями, статьями, hero-изображениями, профилем
- Оплата и личный кабинет покупателя (просмотр покупок, скачивание)
- Поддержка артистов через коллекцию и Premium-планы
